...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!isNaN(num)) {
      ...
      // Format nicely: up to 6 decimals, but remove trailing zeros
  ...
  const handleSwapSwitch = () => {
    ...
    setFromAmount(toAmount); // Swap amounts too roughly
  };
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        {/* Swap Card */}
        <div className="glass-panel rounded-[2rem] p-4 sm:p-6 shadow-[0_20px_50px_rgba(8,_112,_184,_0.1)] border border-white/50">
